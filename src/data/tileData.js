  ...
  all: {
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Council Black Site - You may exhaust this card when an agenda is revealed to predict aloud an outcome of that agenda. If your prediction is correct, draw 1 secret objective.",
          resources: 3,
          influence: 0,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Mystic Library - ACTION: Exhaust this card to replace 1 of your non-faction non-unit upgrade technologies with another technology from your technology deck with the same number of prerequisites.",
          resources: 0,
          influence: 3,
        },
      ],
    ...
    4261: {
      ...
      planets: [
        ...
        },
        {
          name: "Lodran",
          trait: PLANET_TRAITS.HAZARDOUS,
          specialty: [SPECIALTIES.CYBERNETIC],
          resources: 0,
          influence: 2,
        },
      ],
      ...
      planets: [
        {
          name: "Moln",
          trait: PLANET_TRAITS.INDUSTRIAL,
          specialty: [SPECIALTIES.PROPULSION],
          resources: 1,
          influence: 2,
        },
        {
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Gravitational Gambit - At the end of your turn, you may exhaust this card to roll a die. On a result of 1-3 purge each attachment to this planet, and remove all units on this planet from the game board. Otherwise, attach an Improvement card to this planet. (Improvement - ATTACH: This planet's resource and influence values are each increased by 1.)",
          resources: 1,
          influence: 1,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Experimental Gate - At the start of your turn, you may exhaust this card to treat this system as if it had an alpha and beta wormhole until the end of this tactical action.",
          resources: 1,
          influence: 2,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Sacrifice - When you exhaust Casibann to spend its resources or influence, you may exhaust this card to remove any number of infantry on that planet to spend them as resources or influence as well.",
          resources: 0,
          influence: 3,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Equilibrium - When a player would win a combat, you may exhaust this card to treat that combat as a draw instead",
          resources: 0,
          influence: 2,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Vigorous Winds - After you activate a system, you may exhaust this card to apply +1 to the movement value of up to 2 of your ships during this tactical action.",
          resources: 1,
          influence: 2,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Desperation - At the start of a ground combat on a planet you control, you may exhaust this card to choose 1 ground force in the active system; that ground force rolls 1 additional die during each round of that ground combat.",
          resources: 3,
          influence: 1,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Curse of Wealth - At the start of the Strategy phase, you may exhaust this card and any number of planets you control to place a number of trade goods on this card equal to either the combined resource or influence value of those planets. When you ready this card, gain all trade goods on this card.",
          resources: 1,
          influence: 0,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Undying Legions - After 1 of your infantry units is destroyed during combat, you may place that unit on this card. When you pass, you may exhaust this card to place each unit on this card on Stygain.",
          resources: 3,
          influence: 0,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Betrayers' Dagger - Before a player casts votes, you may exhaust this card to choose a player; that player must give you 1 promissory note from their hand, or cast at least 1 vote for the outcome of your choice on that agenda.",
          resources: 0,
          influence: 5,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Violent Demise - At the end of a ground combat on a planet you control, you may exhaust this card to roll 3 dice. For each result of 6 or greater, destroy 1 ground force on that planet.",
          resources: 3,
          influence: 1,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Hand of Force - At the start of your turn, you may exhaust this card to choose 1 of your neighbors; that player must give you 1 promissory note or 1 action card from their hand, if able.",
          resources: 1,
          influence: 3,
        },
      ],
      ...
      planets: [
        {
          ...
          specialty: [SPECIALTIES.LEGENDARY],
          ability:
            "Starlight Throne - When you gain this card, gain 1 victory point; when you lose this card, lose 1 victory point. You score last during the status phase.",
          resources: 4,
          influence: 4,
        },
      ],
    ...
    92: {
      ...
      planets: [
        ...
        },
        {
          name: "Revelation",
          trait: PLANET_TRAITS.NONE,
          specialty: [SPECIALTIES.SPACE_STATION],
          resources: 1,
          influence: 2,
        },
      ],
    ...
    101: {
      ...
      planets: [
        {
          name: "Olergodt",
          trait: [PLANET_TRAITS.CULTURAL, PLANET_TRAITS.HAZARDOUS],
          specialty: [SPECIALTIES.CYBERNETIC, SPECIALTIES.WARFARE],
          resources: 2,
          influence: 1,
        },
      ],
    ...
    104: {
      ...
      planets: [
        {
          name: "Lesab",
          trait: [PLANET_TRAITS.HAZARDOUS, PLANET_TRAITS.INDUSTRIAL],
          specialty: [],
          resources: 2,
          influence: 1,
        },
    ...
    106: {
      ...
      planets: [
        ...
        {
          name: "Lazul Rex",
          trait: [PLANET_TRAITS.INDUSTRIAL, PLANET_TRAITS.CULTURAL],
          specialty: [],
          resources: 2,
          influence: 2,
        },
      ...
      planets: [
        {
          name: "Tiamat",
          trait: PLANET_TRAITS.CULTURAL,
          specialty: [SPECIALTIES.CYBERNETIC, SPECIALTIES.CYBERNETIC],
          resources: 2,
          influence: 1,
        },
        {
...
tileData.green = Object.keys(tileData.all)
  .filter((id) => tileData.all[id].type === "green")
  .filter((id) => !tileData.all[id].special);
tileData.blue = Object.keys(tileData.all)
  .filter((id) => tileData.all[id].type === "blue")
  .filter((id) => !tileData.all[id].special);
tileData.red = Object.keys(tileData.all)
  .filter((id) => tileData.all[id].type === "red")
  .filter((id) => !tileData.all[id].special);
tileData.anomaly = tileData.red.filter(
  (id) => tileData.all[id].anomaly.length > 0,
);
tileData.blankRed = tileData.red.filter(
  (id) => tileData.all[id].anomaly.length === 0,
);
tileData.wormholes = Object.keys(tileData.all)
  .filter((id) => tileData.all[id].wormhole.length > 0)
  .filter((id) => !tileData.all[id].special);
tileData.asteroidFields = tileData.anomaly.filter((id) =>
...
tileData.supernovas = tileData.anomaly.filter((id) =>
  tileData.all[id].anomaly.includes(ANOMALIES.SUPERNOVA),
);

for (const wormhole in WORMHOLES) {
  tileData[`${WORMHOLES[wormhole]}Wormholes`] = Object.keys(tileData.all)
    .filter((id) => tileData.all[id].wormhole.includes(WORMHOLES[wormhole]))
    .filter((id) => !tileData.all[id].special);
}
